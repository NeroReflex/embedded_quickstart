...
define AUTOLOGIN_USERS
    ${BR2_EQ_AUTOLOGIN_USER} ${BR2_EQ_AUTOLOGIN_USER_UID} ${BR2_EQ_AUTOLOGIN_USER} ${BR2_EQ_AUTOLOGIN_USER_GID} =${BR2_EQ_AUTOLOGIN_MAIN_PASSWORD} /home/${BR2_EQ_AUTOLOGIN_USER} /bin/sh render,audio,video,seat Main system user (autologin enabled)
endef
