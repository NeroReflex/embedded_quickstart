...
define VAR_SOM_IMX8MM_INSTALL_BCM43XX_BT
	$(INSTALL) -D -m 755 $(@D)/bcm43xx-bt $(TARGET_DIR)/bluetooth/variscite-bt.d/bcm43xx-bt
endef

define VAR_SOM_IMX8MM_INSTALL_BCM43XX_WIFI
	$(INSTALL) -D -m 755 $(@D)/bcm43xx-wifi $(TARGET_DIR)/wifi/variscite-wifi.d/bcm43xx-wifi
endef
