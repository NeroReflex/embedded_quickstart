SUMMARY = "Opus Audio Codec static  library"
...
#| {standard input}:389: Error: selected processor does not support Thumb mode `smull r>
#| {standard input}:418: Error: selected processor does not support Thumb mode `smull r>
#| {standard input}:448: Error: selected processor does not support Thumb mode `smull r>
#| {standard input}:474: Error: selected processor does not support Thumb mode `smull r>
#| {standard input}:510: Error: selected processor does not support Thumb mode `smull f>
#| {standard input}:553: Error: selected processor does not support Thumb mode `smull f>
#| {standard input}:741: Error: selected processor does not support Thumb mode `smull r>
#| {standard input}:761: Error: selected processor does not support Thumb mode `smull f>
#| {standard input}:773: Error: selected processor does not support Thumb mode `smull f>
