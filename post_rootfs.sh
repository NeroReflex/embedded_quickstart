...
echo "
/sysroot         /                                 bind    bind
/sysroot/home    /sysroot/dev/disk/by-label/rootfs btrfs   subvol=/${HOME_SUBVOL_NAME},skip_balance,compress=zstd,noatime,rw
/sysroot/base    /sysroot/dev/disk/by-label/rootfs btrfs   subvol=/,skip_balance,compress=zstd,noatime,rw
